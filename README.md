...
### Send a friend request and a message to them All!
...
<h1 name="ru" id="ru">Facebook: массово отправить приглашения и кастомизированные сообщения с личными именами друзьям друга</h1>

<b>Автоматическая отправка приглашений и кастомизированных сообщений с личными именами друзьям друга.</b>
